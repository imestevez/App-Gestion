            ...
            <form method="post" name="ADD"  action="../Controllers/GRUPO_Controller.php" >
                ...
                <div id="izquierda">
                    <label for="NombreGrupo"><?php echo $strings['NombreGrupo']?>: </label>
                        <input type="text" name="NombreGrupo" maxlength="60" size="60" onblur="javascript:void(validarNombreGrupo(this, 60))" ><div id="NombreGrupo" class="oculto" style="display:none"><?php echo $strings['div_AlfanumericoTexto']?></div> <div id="NombreGrupoVacio" class="oculto" style="display:none"><?php echo $strings['div_vacio']?></div> 
                </div>
