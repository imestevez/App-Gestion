...
?>
    ...
    ?>
            ...
            <div class="accionesTable">
                <a href="../Controllers/EVALUACION_Controller.php?action=ALL"><input type="image" name="action" value="SHOWALL" src="../Views/images/back.png" title="<?php echo $strings['Volver'] ?>"></a>
            </div>
