...
?>
    <section class="pagina">
            <table class="showcurrent">
                ...
                <tr><th style="width: 5%"><?php echo $strings['Id Funcionalidad'] ?></th><td><?php echo $this->IdFuncionalidad ?></td><td style="border-right-style: collapse; border-bottom:  5px solid black;"> <a href="../Controllers/FUNC_ACCION_Controller.php?action=EDIT&IdFuncionalidad=<?php echo $this->IdFuncionalidad ?>"><input type="image" src="../Views/images/edit.png" name="action" title="<?php echo $strings['Editar'] ?>" value="EDIT"></a></td></tr>
