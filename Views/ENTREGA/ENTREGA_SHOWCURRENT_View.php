                ...
                <tr><th><?php echo $strings['Horas'] ?></th>
                  ...
                  <tr><th><?php echo $strings['Ruta'] ?></th>
                    ...
                    <tr><th><?php echo $strings['NotaTrabajo'] ?></th>
                        ...
                        <td style="border-right-style: collapse; border-right:  5px solid black;border-top:  5px solid black;"> <?php if($this->NotaTrabajo <> ''){ ?> <a href="../Controllers/NOTA_TRABAJO_Controller.php?action=EDIT&IdTrabajo=<?php echo $this->IdTrabajo?>&login=<?php echo $this->login?>&origen=../Controllers/TRABAJO_Controller.php"> <input type="image" style="margin-bottom: 2%" src="../Views/images/edit.png" name="action" title="<?php echo $strings['Editar'] ?>" value="EDIT"></a>  <?php } else{ ?> <a href="../Controllers/NOTA_TRABAJO_Controller.php?action=ADD&IdTrabajo=<?php echo $this->IdTrabajo?>&login=<?php echo $this->login?>&origen=../Controllers/TRABAJO_Controller.php"> <input type="image" style="margin-bottom: 2%" src="../Views/images/anadir.png" name="action" title="<?php echo $strings['Añadir'] ?>" value="ADD"></a><?php } ?> </td>
