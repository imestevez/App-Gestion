    ...
    <?php include '../Views/js/validacionesUSUARIO.js' ?>
     ...
     <section class="pagina">
         <fieldset class="add">
            ...
            <form method="post" name="ADD"  action="../Controllers/Loigin_Controller.php" enctype="multipart/form-data" >
                
                <div id="izquierda">
                    <label for="login"><?php echo $strings['Login']?>: </label>
                        <input type="text" name="login" maxlength="15" size="15" onblur="javascript:void(validarLogin(this, 15))"><div id="login" class="oculto" style="display:none"><?php echo $strings['div_Alfanumerico']?></div> <div id="loginVacio" class="oculto" style="display:none"><?php echo $strings['div_login_vacio']?></div> 
                </div>
               ...
               <div  id="izquierda">
                ...
                <div class="acciones" style="float: right; margin-left:0%; margin-right: 50%">
                    <a href="../Controllers/Registro_Controller.php?action=ADD"> <input type="image" name="action" value="ADD" src="../Views/images/confirmar.png" title="<?php echo $strings['Enviar Formulario'] ?>" onclick="return validar('ADD') && encriptar() "></a>
                </div>
             </form>                     
