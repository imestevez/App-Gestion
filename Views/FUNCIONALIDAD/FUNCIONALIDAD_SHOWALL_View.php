...
?>
         <a href="../Controllers/FUNCIONALIDAD_Controller.php?num_pagina=<?php echo $this->num_pagina-1?>&action=SHOWALL"><input type="image" src="../Views/images/prev.png" name="action" title="<?php echo $strings['Anterior'] ?>" value="PREV"></a>
<?php
        } //Fin del if si es la 1ª tupla

        if($this->max_tuplas < $this->total_tuplas){ //Si la tupla mostrada es la última de la BD
?>
        <a href="../Controllers/FUNCIONALIDAD_Controller.php?num_pagina=<?php echo $this->num_pagina+1?>&action=SHOWALL"><input type="image" src="../Views/images/next.png" name="action" title="<?php echo $strings['Siguiente'] ?>" value="NEXT"></a>
<?php
...
?>  <tr>
                ...
                <td><?php echo $row['NombreAccion']?></td>
                        <td>  <a href="../Controllers/FUNCIONALIDAD_Controller.php?action=SHOWCURRENT&IdFuncionalidad=<?php echo $row["IdFuncionalidad"]?>&IdAccion=<?php echo $row["IdAccion"] ?>">
...
?>
           <a href="../Controllers/FUNCIONALIDAD_Controller.php?action=SHOWALL"><input type="image" src="../Views/images/back.png" name="action" title="<?php echo $strings['Volver'] ?>" value="BACK"></a>
<?php
        }
