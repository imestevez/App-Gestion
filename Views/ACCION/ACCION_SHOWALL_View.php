...
?>
    <section class="pagina" style="min-height: 800px; height: 100%;" >
				...
				<table class="showAll">
                <caption><?php echo $strings['Acciones']?></caption>
                <tr>
                <th><?php echo $strings['Id de la accion']?></th>   
                <th><?php echo $strings['Nombre de la accion']?></th>                   
                <th><?php echo $strings['Descripcion de la accion']?></th>

                <td><a href="../Controllers/ACCION_Controller.php?action=SEARCH"><input type="image" src="../Views/images/search.png" name="action" title="<?php echo $strings['Buscar']?>" value="SEARCH"></a>
                    <a href="../Controllers/ACCION_Controller.php?action=ADD" ><input type="image" src="../Views/images/anadir.png" name="action" title="<?php echo $strings['Añadir']?>" value="ADD" ></a>
                </td>
                </tr>
<?php		
...
?>
                <tr>
                <td><?php echo $row["IdAccion"]; ?></td>
                <td><?php echo $row["NombreAccion"]; ?></td>
                <td><?php echo $row["DescripAccion"]; ?></td>
                <td class="edit_tabla">
                    <a href="../Controllers/ACCION_Controller.php?action=SHOWCURRENT&IdAccion=<?php echo $row["IdAccion"]?>"><input type="image" src="../Views/images/ojo.png" name="action" title="<?php echo $strings['Mostrar en detalle'] ?>" value="SHOWCURRENT" action=""></a>
                    <a href="../Controllers/ACCION_Controller.php?action=EDIT&IdAccion=<?php echo $row["IdAccion"]?>"><input type="image" src="../Views/images/edit.png" name="action" title="<?php echo $strings['Editar'] ?>" value="EDIT"></a>
                    <a href="../Controllers/ACCION_Controller.php?action=DELETE&IdAccion=<?php echo $row["IdAccion"]?>""><input type="image" src="../Views/images/delete.png" name="action" title="<?php echo $strings['Eliminar'] ?>" value="DELETE"></a>
                </td>
                </tr>              
...
?>
         <a href="../Controllers/ACCION_Controller.php?num_pagina=<?php echo $this->num_pagina-1?>&action=SHOWALL"><input type="image" src="../Views/images/prev.png" name="action" title="<?php echo $strings['Anterior'] ?>" value="PREV"></a>
<?php
        } //Fin del if si es la 1ª tupla

        if($this->max_tuplas < $this->total_tuplas){ //Si la tupla mostrada es la última de la BD
?>
        <a href="../Controllers/ACCION_Controller.php?num_pagina=<?php echo $this->num_pagina+1?>&action=SHOWALL"><input type="image" src="../Views/images/next.png" name="action" title="<?php echo $strings['Siguiente'] ?>" value="NEXT"></a>
<?php
...
?>
           <a href="../Controllers/ACCION_Controller.php?action=SHOWALL"><input type="image" src="../Views/images/back.png" name="action" title="<?php echo $strings['Volver'] ?>" value="BACK"></a>
<?php
        }
