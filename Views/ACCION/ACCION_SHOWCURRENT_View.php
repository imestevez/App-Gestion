             ...
             <table class="showcurrent">
                ...
                <tr><th><?php echo $strings['Descripcion de la accion'] ?></th><td><?php echo $this->DescripAccion ?></td></tr>
                    ...
                    <div class="accionesTable">
                     <a href="../Controllers/ACCION_Controller.php?action=ALL"><input type="image" name="action" value="SHOWALL" src="../Views/images/back.png" title="<?php echo $strings['Volver'] ?>"></a>
                 </div>
