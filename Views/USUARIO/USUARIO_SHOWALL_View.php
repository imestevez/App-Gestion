...
?>
    <section class="pagina" style="min-height: 800px; height: 100%;" >
				...
				<table class="showAll">
                <caption><?php echo $strings['Usuarios']?></caption>
                <tr>
...
?>
               ...
               <td>  <a href="../Controllers/USU_GRUPO_Controller.php?action=ALL&login=<?php echo $row["login"]?>&Nombre=<?php echo $row['Nombre']?>">
                            <input type="image" src="../Views/images/lista.png" name="action" title="<?php echo $strings['Mostrar Grupos'] ?>" value="ALL_GRUPOS" action=""></a>
                </td>
                <td class="edit_tabla">
...
?>
         <a href="../Controllers/USUARIO_Controller.php?num_pagina=<?php echo $this->num_pagina-1?>&action=ALL"><input type="image" src="../Views/images/prev.png" name="action" title="<?php echo $strings['Anterior'] ?>" value="PREV"></a>
<?php
        } //Fin del if si es la 1ª tupla

        if($this->max_tuplas < $this->total_tuplas){ //Si la tupla mostrada es la última de la BD
?>
        <a href="../Controllers/USUARIO_Controller.php?num_pagina=<?php echo $this->num_pagina+1?>&action=ALL"><input type="image" src="../Views/images/next.png" name="action" title="<?php echo $strings['Siguiente'] ?>" value="NEXT"></a>
<?php
...
?>
           <a href="../Controllers/USUARIO_Controller.php?action=ALL"><input type="image" src="../Views/images/back.png" name="action" title="<?php echo $strings['Volver'] ?>" value="BACK"></a>
<?php
        }
